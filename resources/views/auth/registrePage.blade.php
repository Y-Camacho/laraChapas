      ...
      <div class="max-w-md w-full space-y-8">
        <div>
          ...
          <p class="mt-2 text-center text-sm text-gray-600">
            ¿Ya tienes cuenta?
            <a href="{{ route('login.show') }}" class="font-medium text-orange-800 hover:text-orange-900">
              Inicia sesión
            </a>
          </p>
        </div>
        ...
        <form class="mt-8 space-y-6" action="{{ route('registre.create') }}" method="POST" novalidate>
          @csrf
